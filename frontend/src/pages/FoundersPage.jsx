      ...
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 px-6 md:px-12" data-testid="founders-hero">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="font-body text-xl text-[#6B7280] italic leading-relaxed mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {achievements.map((item, i) => (
              <motion.div key={item.title} {...fadeUp} transition={{ duration: 0.6, delay: i * 0.1 }}
                className="bg-[#FFFDF7] border border-gray-200 p-6 rounded-xl hover:border-[#007AFF]/30 transition-all"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            {founderPhotos.map((photo, i) => (
              <motion.button
                ...
                onClick={() => setActivePhoto(i)}
                className={`relative aspect-square bg-white border rounded-xl overflow-hidden transition-all ${i === activePhoto ? 'border-[#007AFF] shadow-[0_0_20px_rgba(0,122,255,0.2)]' : 'border-gray-200 hover:border-gray-400'}`}
      ...
      <section className="py-16 px-6 md:px-12 bg-white" data-testid="founders-social">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6">
            <a href="#" className="text-[#6B7280] hover:text-[#007AFF] transition-colors font-heading text-sm uppercase tracking-wider" data-testid="founder-linkedin">
              LinkedIn
            </a>
            <a href="#" className="text-[#6B7280] hover:text-[#007AFF] transition-colors font-heading text-sm uppercase tracking-wider" data-testid="founder-twitter">
              Twitter / X
            </a>
          </div>
        </div>
