        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/technology"
                className="bg-white/10 text-white border border-white/30 font-heading uppercase tracking-widest text-sm py-4 px-8 rounded-full hover:bg-white/20 transition-all"
            ...
            {products.map((product, i) => (
              <motion.div key={product.slug} {...fadeUp} transition={{ duration: 0.6, delay: i * 0.15 }}>
                <Link to={`/products/${product.slug}`}
                  className="block bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-[#007AFF]/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group shadow-sm"
          ...
          <motion.div {...fadeUp}>
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3" data-testid="newsletter-form">
                ...
                />
                <button type="submit"
                  className="bg-[#007AFF] text-white font-heading uppercase tracking-widest text-sm py-3 px-8 rounded-full hover:bg-[#3395FF] hover:shadow-lg hover:shadow-blue-100 transition-all"
