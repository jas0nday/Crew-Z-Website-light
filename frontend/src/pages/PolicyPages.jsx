...
function PageWrapper({ title, children }) {
  return (
    <div className="bg-[#0A0A0A] min-h-screen pt-32 pb-24 px-6 md:px-12">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="font-heading text-4xl sm:text-5xl font-bold uppercase tracking-tighter text-white mb-12">{title}</h1>
        <div className="font-body text-[#A1A1AA] leading-relaxed space-y-6 text-sm">
          {children}
        </div>
      </div>
    </div>
  ...
  return (
    <PageWrapper title="Returns Policy">
      <section data-testid="returns-policy">
        <h2 className="font-heading text-xl text-white uppercase mb-3">30-Day Return Policy</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">How to Return</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">Refunds</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">Damaged or Defective Products</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">Warranty</h2>
  ...
  return (
    <PageWrapper title="Privacy Policy">
      <section data-testid="privacy-policy">
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">Information We Collect</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">How We Use Your Information</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">Data Sharing</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">Your Rights (GDPR)</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">Cookies</h2>
        ...
        <h2 className="font-heading text-xl text-white uppercase mb-3 mt-8">Contact</h2>
