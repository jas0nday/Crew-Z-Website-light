    ...
    <div className="bg-[#FFFDF7]">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="#" className="bg-white border border-gray-200 rounded-xl py-3 px-6 hover:border-gray-400 transition-all inline-flex items-center gap-3" data-testid="app-store-btn">
                ...
                <div className="text-left">
                  <p className="text-[10px] text-[#6B7280] font-body">Download on the</p>
                  <p className="text-sm text-[#1A1A2E] font-heading uppercase">App Store</p>
                </div>
              </a>
              <a href="#" className="bg-white border border-gray-200 rounded-xl py-3 px-6 hover:border-gray-400 transition-all inline-flex items-center gap-3" data-testid="play-store-btn">
                <svg viewBox="0 0 24 24" className="w-6 h-6 text-[#1A1A2E]" fill="currentColor">
                ...
                <div className="text-left">
                  <p className="text-[10px] text-[#6B7280] font-body">Get it on</p>
                  <p className="text-sm text-[#1A1A2E] font-heading uppercase">Google Play</p>
                </div>
              </a>
            </div>
            <p className="mt-4 text-xs text-[#9CA3AF] font-body italic">* App launching alongside hardware. Download links coming soon.</p>
          </motion.div>
        </div>
      </section>

      {/* Features */}
      <section className="py-24 md:py-32 px-6 md:px-12 bg-white" data-testid="app-features">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            <h2 className="font-heading text-4xl md:text-5xl font-bold uppercase tracking-tight text-[#1A1A2E]">Your CrewZ Gets Smarter Over Time</h2>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12" data-testid="app-screenshots">
        <div className="max-w-5xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            <h2 className="font-heading text-4xl md:text-5xl font-bold uppercase tracking-tight text-[#1A1A2E]">App Screens</h2>
          </motion.div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['Live Metrics', 'Coach Dashboard', 'Session History', 'Settings'].map((label, i) => (
              <motion.div key={label} {...fadeUp} transition={{ duration: 0.6, delay: i * 0.1 }}
                className="bg-white border border-gray-200 rounded-xl aspect-[9/16] flex items-center justify-center"
                ...
                <div className="text-center px-4">
                  ...
                  <p className="font-heading text-sm text-[#1A1A2E] uppercase">{label}</p>
                  <p className="font-body text-xs text-[#9CA3AF] mt-1">Screenshot coming soon</p>
                </div>
              </motion.div>
            ))}
          </div>
