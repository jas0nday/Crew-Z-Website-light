...
export const products = [
  {
    ...
    shortDesc: 'GPS rowing computer in a waterproof phone case. One-time purchase, free app included. No subscription required.',
  ...
  },
  {
    ...
    shortDesc: 'Everything in Speed plus integrated audio amplifier for boat speakers. One-time purchase, free app included. No subscription.',
  ...
  },
  {
    slug: 'coach',
    name: 'CrewZ Coach',
    tagline: 'Subscription only. No hardware needed.',
    shortDesc: 'Live-stream your athletes\' data to your tablet. Post-session review free. Live streaming from $9.99/mo.',
    description: 'CrewZ Coach is a subscription coaching platform — no hardware required. Connect to your athletes\' CrewZ units and stream their data live to your tablet, or review session data post-session for free. Choose the plan that fits your squad size.',
    price_usd: 0,
    isSubscription: true,
    subscriptionTiers: [
      { id: 'coach-free', streams: 0, price: 0, annualPrice: 0, label: 'Coach Free', desc: 'Post-session data review only. No live streaming.' },
      { id: 'coach-starter', streams: 1, price: 9.99, annualPrice: 99, label: 'Coach Starter', desc: '1 athlete live stream' },
      { id: 'coach-squad', streams: 4, price: 24.99, annualPrice: 249, label: 'Coach Small Squad', desc: '2\u20134 athlete live streams' },
      { id: 'coach-club', streams: 8, price: 50.00, annualPrice: 500, label: 'Coach Club', desc: '5\u20138 athlete live streams' },
      { id: 'coach-club-plus', streams: 16, price: null, annualPrice: null, label: 'Coach Club+', desc: '9\u201316 athlete live streams \u2014 coming soon' },
    ],
